...
use App\Repository\DiplomeNomRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: DiplomeNomRepository::class)]
class DiplomeNom
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'name', targetEntity: DiplomeFull::class)]
    ...
    public function removeDiplomeFull(DiplomeFull $diplomeFull): self
    {
        if ($this->diplomeFulls->removeElement($diplomeFull)) {
            ...
            if ($diplomeFull->getName() === $this) {
                $diplomeFull->setName(null);
            }
        }
